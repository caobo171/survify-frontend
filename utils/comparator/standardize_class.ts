...
const SPECIAL_WORDS = ["uh", "ah", "oh", "wow"];
...
export class Standardize {
    ...
    static getStandardizedWords = (text: string) => {
    ...
    static paragraph = (text: string) => {
        ...
        // bo viet tat
        Object.keys(CONTRACTIONS).forEach((key: string) => {
            const regex = new RegExp(key, 'g')
            //@ts-ignore
            text = text.replace(regex, CONTRACTIONS[key]);
        });
