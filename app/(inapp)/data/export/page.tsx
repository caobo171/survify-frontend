...
export default function ModelAdvanceBuilderPage() {
    return (
        <ComingSoon 
            ...
            description="We're building powerful data export tools to help you gain insights from your research. This feature will be available soon!"
        />
    );
}
